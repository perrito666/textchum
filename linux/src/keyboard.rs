...
static COMMANDS: &[(&str, &str, &str)] = &[
    ...
    ("newColumn", "New Column", "win.new-column"),
    ("closeColumn", "Close Column", "win.close-column"),
    ("secondView", "Second View", "win.add-view"),
    ("closeView", "Close View", "win.close-view"),
    ("nextPane", "Next Pane", "win.focus-other-group"),
    ...
    ("findNext", "Find Next", "win.find-next"),
    ("findPrevious", "Find Previous", "win.find-previous"),
    ("findAndReplace", "Find and Replace", "win.find-replace"),
    ("revealInTree", "Reveal in Tree", "win.reveal-in-tree"),
    ("complete", "Complete", "win.complete"),
